  ...
  return (
    ...
    <div className='flex flex-col'>
      {userDummyData.map((user,index)=>(
        ...
        key={index} className={`relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer hover:bg-[#282142] max-sm:text-sm ${selectedUser?._id ===user._id ? 'bg-[#282142]/50' : ''}`}>
